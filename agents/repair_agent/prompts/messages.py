...
def get_max_attempts_message(max_attempts: int) -> str:
    ...
    Returns:
        Mensagem formatada
    """
    return f"""Entendo sua frustração. Já tentamos {max_attempts} abordagens diferentes e \
o problema persiste.

Neste ponto, recomendo que você procure um profissional qualificado. \
Alguns problemas podem ser mais complexos do que parecem e podem necessitar:
